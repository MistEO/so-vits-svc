...
output_format = sys.argv[9]  # 音频输出格式

chunks = slicer.cut(input_path, db_thresh=slice_db)
...
res_path = output / f'{input_path.parent.stem}_{key}key_{spk}.{output_format}'
os.makedirs(output, exist_ok=True)
soundfile.write(res_path, audio, svc_model.target_sample, format=output_format)
